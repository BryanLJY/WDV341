...
//Model-Controller Area.  The PHP processing code goes in this area. 
	...
	$inReason = $_POST["reason"];			//Get the value entered in the reason field
	$inReason2 = $_POST["reason2"];			//Get the value entered in the reason2 field
	$inBusiness = $_POST["business"];		//Get the value entered in the business field
...
<p>Reason 2: <?php echo $inReason2; ?></p>
<p>Business: <?php echo $inBusiness; ?></p>
