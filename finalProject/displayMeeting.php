...
{	
	...
	$sql = "SELECT meeting_id,meeting_fname,meeting_lname,meeting_email,meeting_date,meeting_time FROM meetinginfo";	// SQL command
...
<html>
<head>
<title>Bryan Lee - Display Meeting</title>
<meta charset="UTF-8">
  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card-2 w3-white w3-margin-bottom">
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-coffee fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Display Meeting</h2>
        <div class="w3-container">
          <h5 class="w3-opacity"><b>Displaying Meetings</b></h5>
          <div class="container">
<?php
	echo "<h3>" . $query->num_rows . " meetings were found.</h3>";	//display number of rows found by query
?>
<div>
	<table border="5">
	<tr>
	...
	//Turn each row of the result into an associative array 
  	{
		//For each row you have in the array create a table row
  		echo "<tr>";
  		echo "<td>$meeting_fname</td>";
  		echo "<td>$meeting_lname</td>";
  		echo "<td>$meeting_email</td>";
  		echo "<td>$meeting_date</td>";
  		echo "<td>$meeting_time</td>";
		//echo "<td><a href='updateMeetingForm.php?recId=$meeting_id'>Update</a></td>";
		//echo "<td><a href='deleteMeeting.php?recId=$meeting_id'>Delete</a></td>";
  		echo "</tr>\n";
  	}
	$query->close();
